  ...
  return (
    <div className='max-w-screen-xl mt-24 px-8 xl:px-16 mx-auto' id="home">
      <ScrollAnimationWrapper>
        ...
        <ScrollAnimationWrapper
          className="rounded-lg w-full grid grid-flow-row sm:grid-flow-row grid-cols-1 sm:grid-cols-3 py-9 divide-y-2 sm:divide-y-0 sm:divide-x-2 divide-gray-100 bg-stone-50 z-10">
