  ...
  return (
    <div className="bg-gray-100 py-16" id="services">
      <div className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto text-center">
        ...
        {/* CTA */}
        <div className="mt-12 text-black py-10 px-6 rounded-lg">
          ...
          <button className="mt-4 px-6 py-3 bg-black text-white rounded-lg font-semibold hover:bg-gray-900 transition">
            Get Started
          </button>
        </div>
      </div>
