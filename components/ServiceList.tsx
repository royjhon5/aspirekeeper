...
const ServiceList: React.FC = () => {
  ...
  return (
    <div className="bg-gradient-to-b from-white-300 to-white-500 w-full py-16" id="services">
      <div className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto flex flex-col w-full text-cetner justify-center">
        ...
        <ScrollAnimationWrapper className="grid md:grid-cols-2 gap-8 py-12">
          {services.map((service, index) => (
            <motion.div
              ...
              className={`bg-white shadow-lg rounded-md p-6 flex gap-4 items-start border-t-4 ${service.borderColor}`}
            >
